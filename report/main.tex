...
Speech recognition is a technology that's seen a lot improvement in recent years. While common knowledge indicates that the consonants are the most dominant features in recognizing words, sometimes words consist of purely vocalised utterances. Such is the case for words like "man" and "moon". We can see that speech recognition requires  In this paper, we explore methods to differentiate the different vowels from each other using machine learning methods. Our experiments focus on classifying clearly spoken vowels "a", "e", "i", "o" and "u".
